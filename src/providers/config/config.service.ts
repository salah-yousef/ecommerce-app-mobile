...
if (localStorage.languageCode == undefined) {
  ...
  localStorage.languageDirection = "rtl"; //default language direction of app
...
export class ConfigService {
  ...
  public url: string = 'https://ahlmadinah.com/';
  public consumerKey: string = 'ck_cd623d29a8402752562c1c01848da2a3704e010a';
  public consumerSecret: string = 'cs_dee45817f9195cd3dbedda9fb41da3b1bd46fbc2';
  ...
  public homePage = 1;
  public categoryPage = 3;
  public siteUrl = 'https://ahlmadinah.com';
  public appName = 'ahlmadinah';
  public packgeName = 1;
  public introPage = 0;
  ...
  checkingNewSettingsFromServer() {
    this.http.get(this.url + '/api/appsettings/get_all_settings/?insecure=cool').subscribe((data: any) => {
      var settings = data;
      this.address = 'السعودية الرياض';
      this.email = "webmaster@ahlmadinah.com";
      this.latitude = settings.latitude;
      this.longitude = settings.longitude;
      this.phoneNo = "966599260130+";
