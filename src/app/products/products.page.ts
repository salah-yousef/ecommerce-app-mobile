...
export class ProductsPage implements OnInit {
  ...
  categoryName = '';
  sortOrder = 'Newest';
  sortArray = ['Newest', 'A - Z', 'Z - A', 'highest price','lowest price'];
  //, 'A - Z Date', 'Z - A Date'
  ...
  getFilterdProducts(value) {
    ...
    else if (this.sortOrder == "highest price") query = query + "&order_by=price&order=desc";
    else if (this.sortOrder == "lowest price") query = query + "&order_by=price&order=asc";
    ...
    if (this.applyFilter == true) query = query + "&min_price=" + this.price.lower;
    if (this.applyFilter == true) query = query + "&max_price=" + this.price.upper;
  ...
  getFilterdProductsFromWoo() {
    ...
    else if (this.sortOrder == "highest price") q = q + "&orderby=price&order=desc";
    else if (this.sortOrder == "lowest price") q = q + "&orderby=price&order=asc";
