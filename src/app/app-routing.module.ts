...
const routes: Routes = [
  ...
  {
    path: 'sim-card-services',
    loadChildren: () => import('./sim-card-services/sim-card-services.module').then( m => m.SimCardServicesPageModule)
  },
  {
    path: 'sim-card-services-container',
    loadChildren: () => import('./sim-card-services-container/sim-card-services-container.module').then( m => m.SimCardServicesContainerPageModule)
  },
  {
    path: 'sim-card-services-container-child',
    loadChildren: () => import('./sim-card-services-container-child/sim-card-services-container-child.module').then( m => m.SimCardServicesContainerChildPageModule)
  },
